...
//
//class SisalStgWebhookTransTest extends AnyFunSpec with Matchers with GivenWhenThen with BeforeAndAfterEach with BeforeAndAfterAll {
//
...
//
//			// Prepare the test
//			val webhook = new SisalStgWebhookTrans()
